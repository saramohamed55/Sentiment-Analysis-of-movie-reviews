...
pos_file = open('rt-polaritydata/rt-polarity.pos')
pos_sentence = pos_file.readlines()
pos_file.close()

neg_file = open('rt-polaritydata/rt-polarity.neg')
neg_sentence = neg_file.readlines()
neg_file.close()
...
sentence['word_count'] = sentence['review'].apply(count_words)
...
report = classification_report(y_val, y_predlog, output_dict=True)
...
# Generate classification report
report = classification_report(y_val, y_predmnp, output_dict=True)
plot_classification_report(report)
...
# Generate classification report
report = classification_report(y_val, y_predsvc, output_dict=True)
plot_classification_report(report)
